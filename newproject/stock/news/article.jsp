			...
			<div class="page-container">
				<article class="card">
					<%
						...
						int newsNumber = 0;
						if (request.getAttribute("news_number") != null)
							newsNumber = (int) (request.getAttribute("news_number"));
						News nbean0 = newsList.get(newsNumber);
						String newsImage = (String) request.getAttribute("news_image");
						if (newsImage == null)
							newsImage = NewsParameter.getImageName(newsList.get(newsNumber).getStockCode());
					%>
					<img
					...
					<div class="meta">
						<small> <i class="fas fa-user"></i> Written By Nikke Quick
							News
						</small>
